...
class Book(Base):
    ...
    book_reviews = relationship("BookReview", back_populates="book", cascade="all, delete-orphan")
    user_activities = relationship("UserActivity", back_populates="book", cascade="all, delete-orphan")
    source_recommendations = relationship("Recommendation", back_populates="source_book")
    recommendation_items = relationship("RecommendationItem", back_populates="book", cascade="all, delete-orphan") 